franco.js uses [ttezel's twit module](https://github.com/ttezel/twit) to listen on the twitter stream API for mentions of James Franco to retweet and favorite them. 
